    ...
    <div className="flex flex-col gap-12">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col items-center justify-center gap-4 text-center">
          <span className="font-bold text-3xl tracking-tighter">Get a CZK 500 instantly after registering!</span>
          <span>Download the SVAGGY app for faster ordering and personalized recommendations</span>
